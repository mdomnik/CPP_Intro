...
/*   Updated: 2025/02/11 16:30:46 by mdomnik          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	{
		{
			std::cout << "\033[1;32m=== DiamondTrap Constructor Testing ===\033[0m" << std::endl;
			...
			std::cout << "\033[1;34m=== DiamondTrap Functionality Testing ===\033[0m" << std::endl;
			
			namedDiamond.attack("Bandit-01"); //Should use ScavTrap's attack
			namedDiamond.takeDamage(50);
			namedDiamond.beRepaired(20);
			namedDiamond.whoAmI();  //Special function test
			
			copyDiamond.attack("Bandit-02");
			assignedDiamond.takeDamage(30);
			assignedDiamond.beRepaired(30);
			assignedDiamond.whoAmI();
			std::cout << "\033[1;31m=== Test Concluded ===\033[0m" << std::endl;
		}
		{
			std::cout << "\033[1;34m=== DiamondTrap Testing Ground ===\033[0m" << std::endl;
			DiamondTrap diamondy("Diamondy");
			
			for (int i = 0; i < 5; i++) {
				diamondy.attack("Bandit-01");
			}
		
			diamondy.takeDamage(50);
			diamondy.beRepaired(20);
			diamondy.whoAmI();
		
			diamondy.takeDamage(50);
			diamondy.attack("Bandit-01");
			diamondy.beRepaired(50);
			diamondy.whoAmI();
		
			std::cout << "\033[1;31m=== DiamondTrap Test Concluded ===\033[0m" << std::endl;
		}
	}
